...
namespace WMS.Migrations
{
    ...
    [Migration("20200930072700_rolepermission")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Data.MyRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.Data.NavigationMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WMS.Data.RequestType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WMS.Data.RoleMenuPermission", b =>
                {
                    b.Property<string>("RoleId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WMS.Data.MyRequest", b =>
                {
                    ...
                    b.HasOne("WMS.Data.RequestType", "RequestType")
                        .WithMany()
            ...
            modelBuilder.Entity("WMS.Data.NavigationMenu", b =>
                {
                    b.HasOne("WMS.Data.NavigationMenu", "ParentNavigationMenu")
                        .WithMany()
            ...
            modelBuilder.Entity("WMS.Data.RoleMenuPermission", b =>
                {
                    b.HasOne("WMS.Data.NavigationMenu", "NavigationMenu")
                        .WithMany()
